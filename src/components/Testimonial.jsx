...
const Testimonial = () => {
  return (
    <div className="w-full px-12 py-12 md:px-64 md:py-16 flex flex-col md:flex-row font-poppins border-b-2 border-indigo-200">

      <div className="flex flex-col flex-2 gap-6 md:gap-2 items-end justify-center">
